...
- **Movie/Book/Music Recommendations** - Gives recommendations for movies, books, musics
- **Resume Assistant** - Asks a few questions and creates a resume
...
- `/recommendation` - Recommendations from ChatGPT
- `/resume` - Help in creating a resume
...
└── src/
    ...
    └── resources/       # Resource files
        ...
        └── prompts/     # AI prompt templates
            ├── gpt.txt
            ├── random.txt
            ├── recommendation_books.txt
            ├── recommendation_movies.txt
            ├── recommendation_musics.txt
            ├── resume.txt
